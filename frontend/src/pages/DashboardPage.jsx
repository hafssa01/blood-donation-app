...
const Dashboard = () => {
  ...
  const [donations] = useState([
    { id: 1, date: "2024-12-01", amount: "500 ml", donor: "John Doe" },
    { id: 2, date: "2024-12-05", amount: "450 ml", donor: "Jane Smith" },
  ]);

  const [requests] = useState([
    { id: 1, date: "2024-12-10", amount: "300 ml", requester: "Michael Lee" },
    { id: 2, date: "2024-12-15", amount: "400 ml", requester: "Emma Davis" },
  ]);
